...
//         list.push({ name: input, status: redio })
//         setlist([...list])
//         setInput("")
//         setredio("")
...
//             <Popup trigger={<button>Exchange Form</button>} className="Popup" >
...
//               <br /><br />
//               <label htmlFor="">Status</label>&nbsp;&nbsp;
//                     <select value={redio} className="select_input" id="" onChange={(event) => {setredio(event.target.value)}}>
