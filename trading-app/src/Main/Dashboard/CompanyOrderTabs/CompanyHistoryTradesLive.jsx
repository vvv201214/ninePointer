...
export default function CompanyHistoryTradesLive(){
    ...
    useEffect(()=>{
        ...
        axios.get(`${baseUrl}api/v1/readlivetradecompanypagination/${skip}/${limit}`)
        .then((res)=>{
    ...
    function nextData(){
        ...
        console.log(skip)
        axios.get(`${baseUrl}api/v1/readlivetradecompanypagination/${skip+limit}/${limit}`)
        .then((res)=>{
    ...
    numberOfClickForRemoveNext = Math.ceil(((griddatacount))/limit);
    ...
    return(
        ...
        <div class="card my-4">
            ...
            <div class="bg-gradient-success shadow-success border-radius-lg pt-2 pb-1">
                <div><h6 class="text-white text-capitalize ps-3">Historical Trades (Live)</h6></div>
