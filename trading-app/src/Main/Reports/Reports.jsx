                                ...
                                {detailPnlArr.map((elem)=>{
                                    ...
                                    return(
                                        <tr >
                                            ...
                                            <td className="grid2_td" style={elem.pnl>=0.00 ? { color: "green"}:  { color: "red"}}> {elem.pnl - elem.brokerage > 0.00 ? "+₹" + (elem.pnl - elem.brokerage.toFixed(2)): "-₹" + (-(elem.pnl - elem.brokerage).toFixed(2))}</td>
