                    ...
                    <div className="rightside_maindiv">
                        <div className={Styles.main_dateSelData}>
                            ...
                            <div className={Styles.btn_div}>
                                ...
                                <input style={allGross > 0.00 ? { color: "green" } : allGross === 0.00 ? { color: "grey" } : { color: "red" }} type="text" value={allGross > 0.00 ? "+₹" + (allGross.toFixed(2)) : allGross === 0.00 ? "" : "-₹" + (-(allGross).toFixed(2))} className={`${Styles.formInput} ${Styles.formInput1}`} />
                                        ...
                                        <>
                                            {elem.name &&
                                                <tr>
                                                    ...
                                                    {!elem.brokerage ?
                                                        <td className="grid2_td" >{elem.brokerage > 0.00 && "₹" + (elem.brokerage.toFixed(2))}</td>
                                                        :
                                                        <td className="grid2_td" >{elem.brokerage > 0.00 && "₹" + (elem.brokerage.toFixed(2))}</td>}
